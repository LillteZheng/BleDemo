...
import com.excshare.bledemo.databinding.ActivityClientBinding
import com.excshare.client.BleClient
...
import com.excshare.client.client.BleOption
...
class ClientActivity : AppCompatActivity(), OnItemClickListener {
    ...
    private var mBleAdapter: com.excshare.bledemo.ClientActivity.BlueAdapter? = null
    ...
    private fun initRecyclerView() {
        ...
        mBleAdapter = com.excshare.bledemo.ClientActivity.BlueAdapter(
        ...
        val option = BleOption.Builder()
            ...
            .logListener(object : BleOption.ILogListener {
                override fun onLog(log: String) {
                    Log.d(com.excshare.bledemo.ClientActivity.Companion.TAG, log)
