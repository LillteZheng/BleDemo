...
import com.excshare.bledemo.databinding.ActivityServerBinding
import com.excshare.server.BleError
import com.excshare.server.BleServer
...
class ServerActivity : AppCompatActivity() {
    ...
    fun openServer(view: View) {
        ...
        BleServer.get().startServer(builder, object : IBle.IListener {
